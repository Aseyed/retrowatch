...
*/
/*
Retro Watch Arduino v1.0 - Pro Micro Compatible
...
Modified for ATmega32U4 (Arduino Pro Micro) compatibility
...
///////////////////////////////////////////////////////////////////
  ...
  // Hardware Serial1 is on pins 0 (RX) and 1 (TX).
  // I2C is on pins 2 (SDA) and 3 (SCL).
  // SPI is on pins 16 (MOSI), 14 (MISO), 15 (SCK).
  
  // Use Hardware Serial for Bluetooth to avoid conflict with I2C (pins 2/3)
  #define BTSerial Serial1
  
  // Debugging can be done via USB Serial (Serial)
...
///////////////////////////////////////////////////////////////////
//----- BT instance
// BTSerial is defined above based on board type
///////////////////////////////////////////////////////////////////
...
void setup()   {
  #if defined(__AVR_ATmega32U4__)
    // Optional: Enable USB Serial for debugging if needed
